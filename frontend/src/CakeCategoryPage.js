// pages/CakeCategoryPage.jsx
import React, { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import axios from "axios";
import "./CategoryPage.css";

function CakeCategoryPage() {
  ...
  const subcategories = ["Flavors", "Occasional"];
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      const res = await axios.get("http://localhost:5000/api/products/category/Cakes");
    ...
    <div className="category-page">
      ...
      <section className="products-section">
        <h2 className="section-title">
          {activeSubcategory ? `${activeSubcategory}` : "All Cakes"}
        </h2>
