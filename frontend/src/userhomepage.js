...
const addToCart = async (product) => {
  ...
  try {
    ...
    console.log("🛒 Adding to cart:", { userId, productId: product._id }); // Debug log
  ...
  const handleOrder = async (product) => {
    ...
    // Add to cart first, then go to cart page
  ...
  const categories = [
    { 
      id: "all", 
      name: "All Products", 
      image: "/image/catall.jpg"
    },
    { 
      id: "coffee", 
      name: "Coffee", 
      image: "/image/catcoffee.jpg"
    },
    { 
      id: "cupcakes", 
      name: "Cupcakes", 
      image: "/image/catcupcake.jpg"
    },
    { 
      id: "pie", 
      name: "Pies", 
      image: "/image/catpie.jpg"
    },
    { 
      id: "cakes", 
      name: "Cakes", 
      image: "/image/catcake.jpg"
    },
    { 
      id: "gifting", 
      name: "Gift Sets", 
      image: "/image/catgift.jpg"
    }
  ];
  ...
  return (
    <div className="homepage">
      ...
      {/* ===== HERO SECTION ===== */}
      <section className="hero" style={{ backgroundImage: "url('/image/userpage.jpg')" }}>
        ...
        <div className="category-container">
          {categories.map((cat) => (
            ...
            >
              ...
              <p className={`category-name ${activeCategory === cat.id ? 'active' : ''}`}>
                {cat.name}
              </p>
            </div>
          ))}
      ...
      <section className="menu-section">
        ...
        <div className="menu-grid">
          {searchFilteredProducts.length > 0 ? (
            searchFilteredProducts.map((item, index) => (
              <div 
                key={index} 
                className="menu-card"
              ...
              <div className="modal-details">
                ...
                <div className="modal-info-grid">
                  <div className="info-item">
                    ...
                    <span className="info-value price-value">₱{selectedProduct.price?.toFixed(2)}</span>
                  </div>
                  <div className="info-item">
                    <span className="info-label">Stock</span>
                    <span className="info-value stock-value">
                      {selectedProduct.stock || "In Stock"} Available
                    </span>
                  </div>
                </div>
                <div className="modal-actions">
                  <button className="modal-order-btn" onClick={() => handleOrder(selectedProduct)}>
                    Order Now
                  </button>
                  <button className="modal-cart-btn" onClick={() => addToCart(selectedProduct)}>
                    Add to Cart
                  </button>
                </div>
              </div>
